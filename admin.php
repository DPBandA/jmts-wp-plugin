...
function jmts_admin_menu() {
	...
	add_submenu_page( 'jmts-main-menu',
					'JMTS Clients',
					'Clients',
					'manage_options', 'jmts-clients-sub-menu',
					'jmts_clients_submenu' );
	add_submenu_page( 'jmts-main-menu',
					'JMTS Settings',
					'Settings',
...
function jmts_admin_init() {
	add_action( 'admin_post_save_jmts_options', 'process_jmts_options' );
}

function process_jmts_options() {
